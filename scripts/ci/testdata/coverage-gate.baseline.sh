...
#
# ============================================================================
# FROZEN BACKWARD-COMPAT BASELINE — DO NOT EDIT.
#
# This is a byte-for-byte snapshot of the ORG's pre-upgrade
# scripts/ci/coverage-gate.sh (the 255-line aggregate/line-only gate that
# strategos, basileus, and DataFerry depend on). It exists ONLY as the golden
# reference for the backward-compat parity case in coverage-gate.test.sh: the
# new (configurable) coverage-gate.sh must produce a byte-identical verdict
# (exit code) and pr-comment.md to THIS script for a default invocation
# (--coverage-file <x> --threshold N, aggregate/line). Any drift in the new
# script's default path is a silent production regression and must be fixed in
# the new script, never by editing this baseline.
# ============================================================================
#
